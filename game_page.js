...
function check(){
   ...
   if(answer == word){
    ...
    if(answer_turn == "player_name22"){
      answer = "player_name11";
      document.getElementById("player_answer").innerHTML = "answer turn - " + player_name_two;
      player_score_2 = player_score_2 + 1;
      document.getElementById("Score1").innerHTML = player_score_1;
    }

    else{
      answer_turn = "player_name22";
      document.getElementById("player_answer").innerHTML = "answer turn - " + player_name_one;
       player_score_1 = player_score_1 + 1;
       document.getElementById("Score").innerHTML = player_score_2;
    }

    if(question_turn == "player_name2"){
